...
const HorariosDeClase = () => {
  ...
  return (
    <div className="horarios-container">
      <h1 className="horarios-title">Programas</h1>
      ...
      <div className="horarios-links">
        <img
          ...
          onClick={() => window.open("https://epet12smandes.blogspot.com/p/ciclo-basico.html", "_blank")}
        />
        <img
          ...
          className="horario-img"
          style={{ cursor: "pointer", margin: "20px 0", maxWidth: "320px", width: "100%" }}
          onClick={() => window.open("https://epet12smandes.blogspot.com/p/tecnico-mecanico-electricista.html", "_blank")}
        />
        <img
          ...
          className="horario-img"
          style={{ cursor: "pointer", margin: "20px 0", maxWidth: "320px", width: "100%" }}
          onClick={() => window.open("https://epet12smandes.blogspot.com/p/maestro-mayor-de-obras_10.html", "_blank")}
        />
        <img
          ...
          className="horario-img"
          style={{ cursor: "pointer", margin: "20px 0", maxWidth: "320px", width: "100%" }}
          onClick={() => window.open("https://epet12smandes.blogspot.com/p/4-ano-5-ano-6-ano-arquitectura-i.html", "_blank")}
        />
      </div>
    </div>
  );
